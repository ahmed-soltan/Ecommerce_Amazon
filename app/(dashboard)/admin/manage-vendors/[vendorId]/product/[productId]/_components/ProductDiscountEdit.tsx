...
import ProductDiscount from "@/app/(dashboard)/vendor/[vendorId]/create-product/_components/ProductDiscount";
  ...
  return (
    <div className="bg-slate-100 w-full p-5 flex flex-col gap-2">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-medium text-slate-700">Product Discount</h2>
        <Button
          variant={"ghost"}
