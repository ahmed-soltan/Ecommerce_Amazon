...
const Success = ({profile}:{profile:Profile}) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full gap-5 h-full">
        ...
        <h1 className="text-slate-900 font-medium text-center text-3xl">Purchased Successfully</h1>
        <p className="text-slate-700 font-medium text-center text-xl">Thank You For Your Purchased Your Order Will get You ASAP</p>
